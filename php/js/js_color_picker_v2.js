...
************************************************************************************************************/	
	...
	var form_widget_amount_slider_handle = pathToImages + 'slider_handle.gif';
		...
		do
		{
			if (subDiv.tagName == 'DIV' && subDiv.className != 'colorPickerCloseButton')
			{
				if (subDiv == thisObj)
				{
					...
					img.src = pathToImages + "tab_right_active.gif"
				...
				else
				{
					...
					img.src = pathToImages + "tab_right_inactive.gif";
					if(activeColorDiv)
	...
	function createColorPickerTopRow(inputObj)
	{
		...
		for (var no = 0; no < tabs.length; no++)
		{
			...
			tabImg.src = pathToImages + "tab_right_" + suffix + ".gif";
