		...
		do
		{
            ...
            if ($start)
            {
                ...
                if ($startDate <= $Period[P_END])
                {
                    ...
                    $errContext = $context;
                    $errQuery = '';
                    $errText = 'Start date affects earlier period';
                    break;
                }
            }
			...
			if ($stop)
			{
				...
				if ($stopDate < $Period[P_END])
				{
					...
					$errContext = $context;
					$errQuery = '';
					$errText = 'Stop date affects earlier period';
					break;
				}
			}
			...
			if ($start && $stop)
			{
				if ($stopDate < $startDate)
				{
                    ...
                    $errContext = $context;
					$errQuery = '';
					$errText = 'Stop occurrs before start';
					break;
				}
				if ($startDate == $stopDate)
				{
                    ...
                    $errContext = $context;
					$errQuery = '';
					$errText = 'Start and Stop are the same date';
					break;
				}
			}
