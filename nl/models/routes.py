...
class Route(db.Model):
    ...
    sequences = db.relationship(
        "Sequence",
        primaryjoin="Route.id == routes_sequence.c.route_id",
        backref="route",
    )
...
class ChangeNote(db.Model):
    ...
    route = db.relationship(
        "Route",
        primaryjoin="ChangeNote.route_id == routes.c.id",
...
class Sequence(db.Model):
    ...
    route_id = db.Column(
        db.ForeignKey("routes.id", ondelete="CASCADE", onupdate="CASCADE"),
        primary_key=True,
    )
    ...
    customer = db.relationship(
        "Customer", primaryjoin="Sequence.tag_id == customers.c.id", backref="sequence"
    )
