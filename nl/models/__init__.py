...
class Alert(db.Model):
    ...
    user = db.relationship('User', primaryjoin='Alert.user_id == User.id',
                           backref='alerts')
...
class AuditLog(db.Model):
    ...
    user_id = db.Column(db.ForeignKey('User.id', ondelete='RESTRICT', onupdate='CASCADE'))
